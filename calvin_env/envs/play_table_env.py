...
def get_env(dataset_path, obs_space=None, show_gui=True, **kwargs):
    ...
    if ood_env and ood_obj:
        ...
        render_conf.scene.objects.movable_objects.block_red.file = 'blocks/block_red_middle_3.urdf'
        render_conf.scene.objects.movable_objects.block_blue.file = 'blocks/block_blue_small_4.urdf'
        render_conf.scene.objects.movable_objects.block_pink.file = 'blocks/block_pink_big_9.urdf'
        ...
        #   block_red  -> green  (index 3) : blocks/block_red_middle_3.urdf
        #   block_blue -> yellow (index 4) : blocks/block_blue_small_4.urdf
        #   block_pink -> purple (index 9) : blocks/block_pink_big_9.urdf
