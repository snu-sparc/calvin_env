"""
modified from reset_env_rendered_episode.py
...
DEBUG_DATASET_ROOT_DIR = '/home/ksshin/projects/sparc/calvin/dataset/calvin_debug_dataset/training'
...
def run_env(cfg):
    ...
    for ridx, (start, end) in enumerate(indx_ranges):
        ...
        for i in range(start, end + 1):
            ...
            out = {
                "rgb_static": o["rgb_obs"]["rgb_static"],
                "rgb_gripper": o["rgb_obs"]["rgb_gripper"],
                "rel_actions": action_noisy,
                "robot_obs": data["robot_obs"],
                "scene_obs": data["scene_obs"],
            }

            out_file = root_dir / f"episode_{i:07d}_noisy.npz"
